...
const HomeBody = () => {
  ...
  return (
    <>
      ...
      >
        {/* Background Image */}
        <div className="header-bgimage container align-items-center d-flex">
          {/* Main Content */}
          {/* <div className="header-content">
            <p className="lang" data-key="hero_section_p1">
              A vibrant festival that brings families and communities together
              to welcome wisdom, prosperity, and new beginnings.
            </p>

            <button type="button" className="btn btn-primary navbar-btn">
              <a
                className="lang"
                data-key="hero_section_btn1"
                href="https://play.google.com/store/apps/details?id=com.starline.my_fest&amp;hl=en_IN"
              >
                Download MyFest Now
              </a>
            </button>
          ...
          <div className="header-content">
            <button
              type="button"
              className="rounded-5 btn btn-primary navbar-btn py-2 px-4"
            >
              <a
                className="lang"
                data-key="hero_section_btn1"
          ...
          <div className="row d-flex">
            <div className="header-content col d-flex flex-column ">
              ...
              <p className="pb-2 lang" data-key="section2_p1">
                ...
                सोपे आणि सुविधाजनक झाले आहे! डिजिटल अहवाल फीचरच्या माध्यमातून
                पूर्वीचे आर्थिक व्यवहार आणि हिशोब एका क्लिकवर पाहता येतील.
                गणेशोत्सव आणि इतर सणांचे महत्त्व फेस्टिव्ह बुक्सच्या द्वारे
                समजून घ्या. देणगी व्यवस्थापनासाठी डिजिटल पावती प्रणाली वापरा आणि
                संपूर्ण देणगीदार माहिती सुरक्षित ठेवा.
              </p>

              <p className="lang" data-key="section2_p2">
                लाईव्ह गणपती दर्शनाने जगभरातून आपल्या बाप्पांचे दर्शन घ्या.
                डिजिटल जाहिरात मासिकाच्या मदतीने मंडळाचे उपक्रम प्रसिद्ध करा.
                फोटो गॅलरीमध्ये उत्सवाचे सर्व आठवणींचे जतन करा आणि शेअर करा. कमी
                कागदपत्रांसह पेपरलेस व्यवस्थापन करा आणि सोपी ऑपरेशन प्रणाली
                वापरून सहज ऍप ऑपरेट करा. 'मायफेस्ट' डाउनलोड करा आणि गणेशोत्सव
                डिजिटल बनवा!
              </p>
              ...
              <div className="section4-box-part">
                ...
                <div className="section4-box-part-content">
                  ...
                  <p className="lang" data-key="section4_box1_p">
                    देणगी व्यवस्थापन आता पूर्णतः डिजिटल! एका क्लिकवर
                    देणगीदारांना पावती द्या आणि हिशोब ठेवा.
                  </p>
                </div>
              </div>
              <div className="section4-box-part">
                ...
                <div className="section4-box-part-content">
                  ...
                  <p className="lang" data-key="section4_box2_p">
                    गणेशोत्सवाचे सर्व सुंदर क्षण एका जागी! फोटो आणि आठवणी जतन
                    करा आणि शेअर करा.
                  </p>
                </div>
              </div>
              <div className="section4-box-part">
                ...
                <div className="section4-box-part-content">
                  ...
                  <p className="lang" data-key="section4_box3_p">
                    आता तुमच्या गणपती मंडळाच्या आर्थिक व्यवहारांचा संपूर्ण अहवाल
                    एका क्लिकवर मिळवा! पूर्वीच्या हिशोबांची माहिती तपासा आणि
                    पारदर्शक व्यवस्थापन करा.
                  </p>
                </div>
              </div>
              <div className="section4-box-part">
                ...
                <div className="section4-box-part-content">
                  ...
                  <p className="lang" data-key="section4_box4_p">
                    मंडळाच्या विविध उपक्रमांसाठी डिजिटल जाहिरात सुविधा.
                    प्रायोजकांसाठी उत्कृष्ट जाहिरात संधी उपलब्ध.
                  </p>
                </div>
              </div>
              <div className="section4-box-part">
              ...
              <div className="section4-box-part">
                ...
                <div className="section4-box-part-content">
                  ...
                  <p className="lang" data-key="section4_box6_p">
                    आता आपल्या गणपती मंडळाच्या दररोजच्या आरतीचे संपूर्ण
                    व्यवस्थापन फक्त एका क्लिकवर! मागील आरतीचे रेकॉर्ड सहज तपासा
                    आणि पारदर्शक व सुस्थित व्यवस्थापन राखा.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="section4-box-pagination dots">
                {[0, 1, 2].map((num) => (
                  <span
                    key={num}
                    className={
                      sliderIndex.slider1 === num ? "dot active" : "dot"
                    }
              ...
              <div className="section4-box-pagination dots">
                {[0, 1, 2].map((num) => (
                  <span
                    key={num}
                    className={
                      sliderIndex.slider2 === num ? "dot active" : "dot"
                    }
      ...
      >
        <div className="container" ref={containerRef}>
          <div
            className={`row d-flex video-wrapper ${isPlaying ? "active" : ""}`}
          >
            <video
              ref={videoRef}
            ...
            {!isPlaying && (
              <img
                className="elementor-video-thumbnail"
                src={section5videobg}
                alt=""
              />
            )}
        ...
        <img
          className="runninrat"
          ref={ratRef}
          src={section5runningrat}
          alt="running rat"
        />
      </section>

      {/*  section6 */}
      <section className="section6 py-5" id="plains-section">
        <div className="container">
          <div className="row ">
            <h2 className="text-center lang" data-key="section6_h2_1">
              ॲप योजना तपशील
            </h2>

            <div className="section6-price d-flex gap-5 justify-content-center">
              <div
                className="section6-price-box p-5"
              ...
              >
                ...
                <span
                  className="section6-spanhlp d-flex lang"
                  data-key="section6_silver_span1"
                >
                  आयुष्यभरासाठी ॲप खर्च
                </span>
                <span
                  className="section6-spanhlp2 d-flex lang"
                  data-key="section6_silver_span2"
                >
                  ₹ 5100
                </span>
                <ul className="elementor-price-table__features-list">
                  <li className="elementor-repeater-item-4d655ef">
                    <div className="elementor-price-table__feature-inner  d-flex gap-2">
                      <svg
                        aria-hidden="true"
                ...
                <div className="elementor-price-table">
                  <div>
                    <span
                      className="Maintanace lang"
                      data-key="section6_silver_maint"
                    >
                      वार्षिक देखभाल शुल्क
                    </span>
                    <p className="lang" data-key="section6_silver_p1">
                      सिल्व्हर : ₹5100
                    </p>
                  </div>

                  <div>
                    <p className="lang" data-key="section6_silver_p2">
                      या गोष्टींसाठी अजिबात अतिरिक्त पैसे नाहीत:
                    </p>
                    <p className="lang" data-key="section6_silver_p3">
                      1) एसएमएस संदेश < br/> 2) मासिक बातम्या
                    </p>  
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <span
                  className="d-flex section6-spanhlp lang"
                  data-key="section6_gold_span1"
                >
                  आयुष्यभरासाठी ॲप खर्च
                </span>
                <span
                ...
                <div className="elementor-price-table">
                  ...
                  <div>
                    <p className="lang" data-key="section6_gold_p2">
                      या गोष्टींसाठी अजिबात अतिरिक्त पैसे नाहीत:
                    </p>
      ...
      {showPopup && (
        <div className="popup-section d-flex gap-5 justify-content-center vh-100 position-fixed top-0 w-100 align-items-center z-5 ">
          {/* SILVER */}
          <div
            className={`section6-price-box p-5 ${
            ...
            <ul className="elementor-price-table__features-list">
              ...
              <li className="elementor-repeater-item-95528f2">
                <div className="elementor-price-table__feature-inner  d-flex gap-2">
                  ...
                  <span className="lang" data-key="section6_gold_li4">
                    Digital Advertisement Magazine
                  </span>
                </div>
              </li>
              <li className="elementor-repeater-item-95528f2">
          ...
          {/* CLOSE BUTTON */}
          <div
            className="position-absolute top-0 end-0 m-4 cursor-pointer "
